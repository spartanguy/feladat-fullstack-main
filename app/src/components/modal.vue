    ...
    <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div class=" w-[100%] md:w-[60%] max-w-3xl p-2 md:p-6 bg-white shadow-lg rounded-lg flex flex-col relative z-10">     
        ...
        <div class="flex gap-6">
          <div class="flex-1">
            ...
            <div class="mb-3">
              ...
              <input v-model="user.name" type="text" class="w-full p-1.5 border rounded-lg" />
            </div>
            
            <div class="mb-3">
              <label class="block text-sm font-medium">Email</label>
              <input v-model="user.email" type="email" class="w-full p-1.5 border rounded-lg" />
            </div>
            
            <div class="mb-3">
              <label class="block text-sm font-medium">Jelszó</label>
              <input v-model="user.password" type="password" class="w-full p-1.5 border rounded-lg" />
            </div>
            
            <div class="mb-3">
              <label class="block text-sm font-medium">Jelszó újra</label>
              <input v-model="user.confirmPassword" type="password" class="w-full p-1.5 border rounded-lg" />
            </div>
          </div>
        ...
        <div class="mt-4 flex justify-center gap-6">
          ...
          <Button @click="save" intent="secondary" >Mentés</Button>
        </div>
      </div>
    </div>
  </Teleport>
